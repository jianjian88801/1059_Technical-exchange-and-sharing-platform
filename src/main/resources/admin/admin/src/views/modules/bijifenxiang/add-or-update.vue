<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="笔记类型" prop="bijileixing">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="笔记标题" prop="bijibiaoti">
          <el-input v-model="ruleForm.bijibiaoti" 
              placeholder="笔记标题" clearable  :readonly="ro.bijibiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="笔记标题" prop="bijibiaoti">
              <el-input v-model="ruleForm.bijibiaoti" 
                placeholder="笔记标题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.bijitupian" label="笔记图片" prop="bijitupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.bijitupian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="笔记附件" prop="bijifujian">
          <file-upload
          tip="点击上传笔记附件"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.bijifujian?ruleForm.bijifujian:''"
          @change="bijifujianUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.bijifujian" label="笔记附件" prop="bijifujian">
            <el-button type="text" size="small" @click="download(ruleForm.bijifujian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.bijileixing = true;
          ...
          if(o=='bijibiaoti'){
            this.ruleForm.bijibiaoti = obj[o];
	    this.ro.bijibiaoti = true;
            continue;
          }
          if(o=='bijitupian'){
	    ...
	    this.ro.bijitupian = true;
          ...
          if(o=='bijifujian'){
            this.ruleForm.bijifujian = obj[o];
	    this.ro.bijifujian = true;
            continue;
          }
          if(o=='bijineirong'){
	...
	this.ruleForm.bijineirong = this.ruleForm.bijineirong.replace(reg,'../../../springboot1o52x/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    bijifujianUploadChange(fileUrls) {
	this.ruleForm.bijifujian = fileUrls;
			this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
