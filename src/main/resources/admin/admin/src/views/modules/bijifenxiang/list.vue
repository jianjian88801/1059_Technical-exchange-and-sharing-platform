                  ...
                  <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="bijitupian"
                    ...
                    <template slot-scope="scope">
                      <div v-if="scope.row.bijitupian">
                        <img :src="scope.row.bijitupian.split(',')[0]" width="100" height="100">
                      </div>
                      <div v-else>无图片</div>
                    </template>
                  </el-table-column>
                  <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="bijifujian"
                    header-align="center"
                    label="笔记附件">
                    <template slot-scope="scope">
                      <el-button type="text" size="small" @click="download(scope.row.bijifujian)">下载</el-button>
                    </template>
                  </el-table-column>
                <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                    prop="faburiqi"
...
export default {
  ...
  methods: {
    ...
    init () {
          this.$http({
            url: `option/bijileixing/leixing`,
            method: "get"
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.bijileixingOptions = data.data;
            } else {
